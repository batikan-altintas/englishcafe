...
namespace BatikanSon.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            TempData["roles"] = new SelectList(_roleManager.Roles.Where(x => x.Name != "Admin").ToList(), "Id", "Name");
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var roleresult = _roleManager.FindByIdAsync(Input.Role).Result;

                    if(user.Ad == "Admin")
                    {
                        await _userManager.AddToRoleAsync(user, "Admin");
                    }
                    if (roleresult != null && user.Ad != "Admin")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            if (roleresult.Name == "Ogrenci")
                                return LocalRedirect("~/OgrenciPanel/Randevular");
                            if (roleresult.Name == "Ogretmen")
